...
class Args:
    # common args
    exp_name: str = "llama_3_8b_sft_ultrafeedback"
    ...
    output_dir: str = "models/llama_3_8b_sft_ultrafeedback"
...
if __name__ == "__main__":
    ...
    train_val_split = dataset.train_test_split(test_size=0.1, seed=args.seed) # we want the same split across GPUs!
